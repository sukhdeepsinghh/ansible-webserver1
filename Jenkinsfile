pipeline {
    ...
    stages {
       ...
       stage('Send Slack Notification'){
        ...
        sh 'export ANSIBLE_ROLES_PATH=/opt/jenkins/workspace/ansible-pipeline/roles/website && ansible-playbook -u $USER --private-key $KEY_FILE -i $WORKSPACE/host_inventory $WORKSPACE/playbooks/website-update.yml'
       }
       }
       stage('Test Website'){
       steps {
